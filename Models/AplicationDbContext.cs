...
namespace Test_Migracion_.Models
{
    public class AplicationDbContext : DbContext
    {
        ...
        {
            //Person DbSet
            modelBuilder.Entity<Person>().Property(x => x.PersonId).HasColumnName("Id").UseIdentityColumn(1,1).IsRequired();
            ...
            //Requests DbSet
            modelBuilder.Entity<Requests>().Property(x => x.RequestsId).HasColumnName("Id").UseIdentityColumn(1, 1).IsRequired();
            ...
            //Equipment DbSet
            modelBuilder.Entity<Equipment>().Property(x => x.EquipmentId).HasColumnName("Id").UseIdentityColumn(1, 1).IsRequired();
            modelBuilder.Entity<Equipment>().Property(x => x.PersonId).HasColumnName("PersonId").IsRequired();
            modelBuilder.Entity<Equipment>().Property(x => x.RequestsId).HasColumnName("RequestsId").IsRequired();
